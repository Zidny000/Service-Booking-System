...
<head>
    ...
    <title>Qtec API Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-register">Register a new account.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-login">
                                <a href="#endpoints-POSTapi-login">Login and return auth token.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-get-user">
                                <a href="#endpoints-GETapi-get-user">Get list of users (paginated) — protected route.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-logout">
                                <a href="#endpoints-POSTapi-logout">Logout user and revoke tokens — protected route.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-services">
                                <a href="#endpoints-GETapi-services">Display a listing of the services.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-bookings">
                                <a href="#endpoints-POSTapi-bookings">Store a newly created booking in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-bookings">
                                <a href="#endpoints-GETapi-bookings">Display a listing of the current user's bookings.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-admin-services">
                                <a href="#endpoints-GETapi-admin-services">Display a listing of all services (Admin only).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-services">
                                <a href="#endpoints-POSTapi-services">Store a newly created service in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-services--id-">
                                <a href="#endpoints-PUTapi-services--id-">Update the specified service in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-services--id-">
                                <a href="#endpoints-DELETEapi-services--id-">Remove the specified service from storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-admin-bookings">
                                <a href="#endpoints-GETapi-admin-bookings">Display a listing of all bookings (Admin only).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-admin-bookings--id--status">
                                <a href="#endpoints-PUTapi-admin-bookings--id--status">Update the status of a booking (Admin only).</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: August 28, 2025</li>
    </ul>
</div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-register">Register a new account.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 4 characters. Example: <code>vmqeopfuudtdsufvyvddqamniihfqcoynlazghdtqtqxbajwbpilpmufinllwloauydlsmsjur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>oschulist@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Must be at least 8 characters. Example: <code>z&amp;~na%x</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-login">Login and return auth token.</h2>
...
<p>Example: <code>O[2UZ5ij-e/dl4m{o,</code></p>
                    ...
                    <h2 id="endpoints-GETapi-get-user">Get list of users (paginated) — protected route.</h2>
...
<span id="example-requests-GETapi-get-user">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-get-user">
            <blockquote>
...
<span id="execution-results-GETapi-get-user" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-get-user"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-get-user"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-get-user" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-get-user">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-get-user" data-method="GET"
      data-path="api/get-user"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-get-user', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-get-user"
                    onclick="tryItOut('GETapi-get-user');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-get-user"
                    onclick="cancelTryOut('GETapi-get-user');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-get-user"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-get-user"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-get-user"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-logout">Logout user and revoke tokens — protected route.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-services">Display a listing of the services.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-bookings">Store a newly created booking in storage.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="service_id"                data-endpoint="POSTapi-bookings"
               value="consequatur"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>today</code>. Example: <code>2106-09-27</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Must not be greater than 1000 characters. Example: <code>mqeopfuudtdsufvyvddqa</code></p>
                    ...
                    <h2 id="endpoints-GETapi-bookings">Display a listing of the current user&#039;s bookings.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-services">Display a listing of all services (Admin only).</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-services">Store a newly created service in storage.</h2>
...
<ul style="list-style-type: square;"><li><code>active</code></li> <li><code>inactive</code></li></ul>
                    ...
                    <h2 id="endpoints-PUTapi-services--id-">Update the specified service in storage.</h2>
...
<div class="bash-example">
    ...
    "http://localhost:8000/api/services/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"vmqeopfuudtdsufvyvddq\",
...
<ul style="list-style-type: square;"><li><code>active</code></li> <li><code>inactive</code></li></ul>
                    ...
                    <h2 id="endpoints-DELETEapi-services--id-">Remove the specified service from storage.</h2>
...
<p>The ID of the service. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-bookings">Display a listing of all bookings (Admin only).</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-admin-bookings--id--status">Update the status of a booking (Admin only).</h2>
...
<span id="example-requests-PUTapi-admin-bookings--id--status">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/admin/bookings/consequatur/status" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"status\": \"cancelled\"
...
<span id="example-responses-PUTapi-admin-bookings--id--status">
</span>
<span id="execution-results-PUTapi-admin-bookings--id--status" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-admin-bookings--id--status"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-admin-bookings--id--status"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-admin-bookings--id--status" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-admin-bookings--id--status">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-admin-bookings--id--status" data-method="PUT"
      data-path="api/admin/bookings/{id}/status"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-admin-bookings--id--status', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-admin-bookings--id--status"
                    onclick="tryItOut('PUTapi-admin-bookings--id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-admin-bookings--id--status"
                    onclick="cancelTryOut('PUTapi-admin-bookings--id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-admin-bookings--id--status"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-darkblue">PUT</small>
            <b><code>api/admin/bookings/{id}/status</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-admin-bookings--id--status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-admin-bookings--id--status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-admin-bookings--id--status"
               value="consequatur"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PUTapi-admin-bookings--id--status"
               value="cancelled"
               data-component="body">
    <br>
